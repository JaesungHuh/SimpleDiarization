...
- pyannote_token : You need to put token to use pyannote vad model. Please visit [here](https://github.com/pyannote/pyannote-audio) and [here](https://huggingface.co/settings/tokens) for more information.
